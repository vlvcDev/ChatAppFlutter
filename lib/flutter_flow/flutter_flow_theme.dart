...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF2A2D34);
  late Color secondary = const Color(0xFF4ECDC4);
  late Color tertiary = const Color(0xFFF26430);
  late Color alternate = const Color(0xFFF7FFF7);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFF7FFF7);
  late Color secondary = const Color(0xFF4ECDC4);
  late Color tertiary = const Color(0xFFF26430);
  late Color alternate = const Color(0xFF2A2D34);
